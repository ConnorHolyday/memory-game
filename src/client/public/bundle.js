...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoContainer = __webpack_require__(/*! ./TodoContainer.jsx */ 168);
...
/* 168 */
/*!******************************************!*\
  !*** ./src/client/app/TodoContainer.jsx ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoItem = __webpack_require__(/*! ./TodoItem.jsx */ 169);
	...
	var TodoContainer = function (_React$Component) {
		...
		_createClass(TodoContainer, [{
			...
			value: function loadTodos() {
				var data = __webpack_require__(/*! ./TodoData.json */ 170);
		...
		function TodoContainer(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoContainer).call(this, props));
		...
		_createClass(TodoContainer, [{
			...
			value: function addTodo() {
				...
				this.setState(function (state) {
					return { todos: state.todos.concat({ "id": id, "desc": "Test" }) };
				});
			}
		}, {
			key: 'render',
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.state.todos.map(function (item) {
							return _react2.default.createElement(_TodoItem2.default, { key: item.id, desc: item.desc });
						})
					)
				);
			}
